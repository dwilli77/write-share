    ...
    return (
        <>
            ...
            <div className="row">
                ...
                <button disabled={!checkInputs()} className="btn waves-effect waves-light btn-large right main-button-font orange darken-3"  onClick={() => props.handleNewPod(props.userId, form.podName, form.topic, form.numParticipants)}>Submit
